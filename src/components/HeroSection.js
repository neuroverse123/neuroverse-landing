...
const HeroSection = ({ title, subtitle, primaryButtonText, secondaryButtonText }) => {
  return (
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-7xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-8 mx-auto max-w-2xl text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">
